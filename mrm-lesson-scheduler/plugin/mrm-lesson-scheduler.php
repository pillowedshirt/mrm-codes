...
class MRM_Lesson_Scheduler {
    ...
    // Deprecated: all-sheet-music access is now controlled by Payments Hub add-on ledger only.
    ...
    public function rest_book_lesson( WP_REST_Request $request ) {
        ...
        // NOTE: All-sheet-music access is ONLY granted by the $5 add-on payment logic in Payments Hub.
        // (Removed: auto-enroll lesson purchasers into all-sheet-music access.)
