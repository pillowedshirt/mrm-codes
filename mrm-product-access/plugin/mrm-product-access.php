  ...
  boxes.forEach(function(box){
    ...
    private function output_catalog_assets_inline() {
        ...
        .mrm-pdfModal {
          ...
          box-shadow: 0 24px 70px rgba(27, 20, 15, 0.22);
          display: flex;
          cursor: zoom-out;
        }
...
/* Final shortcode PDF preview override: keep catalog previews large, transparent, and centered. */
.mrm-sheet-music-catalog-section .pdf-col {
  display: flex !important;
  justify-content: center !important;
  align-items: center !important;
...
.mrm-piece-details-wrapper .mrm-pdfOverlay.is-open {
  display: flex !important;
  align-items: center !important;
  justify-content: center !important;
}

.mrm-sheet-music-catalog-section .mrm-pdfModal,
.mrm-piece-details-wrapper .mrm-pdfModal {
  ...
  .mrm-piece-details-wrapper .mrm-otpOverlay .modal {
    ...
    overscroll-behavior: contain !important;
        ...
        (function(){
          ...
          function mrmProductAccessPopupTextFieldFocused() {
            var el = document.activeElement;
            return !!(
              el &&
              el.matches &&
              el.matches('input:not([type="checkbox"]):not([type="radio"]):not([type="hidden"]), textarea') &&
          ...
          function mrmProductAccessSyncMobileViewport(force) {
            if (!force && mrmProductAccessPopupTextFieldFocused()) return;
